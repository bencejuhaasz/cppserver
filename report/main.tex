...
% Itt jön a motiváció bevezető szövege.

\subsection{Elméleti háttér}
\label{ssec:elmeleti-hatter}

% Itt jön a queueing theory rövid ismertetése.
...
% Tartalom: a 4 hipotézis tömör megfogalmazása listában vagy bekezdésekben.
%
% Pl.:
 \begin{itemize}
...
% - Hardver: laptop CPU (4 fizikai mag, 8 logikai mag, hyperthreading)
% - OS, kernel, fordító verziók
% - Mérőeszköz: wrk
% - Mag-pinning stratégia (taskset)
% - Warmup, mérési idő, ismétlések
% - Adatfeldolgozás: Python szkriptek, statisztika

% Itt jönnek a mérési környezet részletei.
...
% Néhány lehetséges irány felsorolása:
% \begin{itemize}
